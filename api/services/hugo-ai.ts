...
export interface SyncRequest {
  ...
  requestedData: Array<'insights' | 'recommendations' | 'modelUpdates' | 'preferences' | 'progress'>;
}
...
export class HugoAIService {
  ...
  private async generateInsights(userData: any[], domain?: CognitiveDomain): Promise<InsightsResponse> {
...
let hugoAIServiceInstance: HugoAIService | null = null;

export const getHugoAIService = (supabase: SupabaseClient): HugoAIService => {
