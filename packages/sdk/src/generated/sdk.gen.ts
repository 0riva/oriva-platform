...
export const getAuthProfile = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<GetAuthProfileResponses, GetAuthProfileErrors, ThrowOnError>({
    security: [
 ...
 */
export const putAuthProfile = <ThrowOnError extends boolean = false>(
  options?: Options<PutAuthProfileData, ThrowOnError>
) =>
  (options?.client ?? client).put<PutAuthProfileResponses, PutAuthProfileErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/auth/profile',
    ...options,
    headers: {
 ...
 */
export const listUpcomingSessions = <ThrowOnError extends boolean = false>(
  options?: Options<ListUpcomingSessionsData, ThrowOnError>
) =>
  (options?.client ?? client).get<
    ListUpcomingSessionsResponses,
    ListUpcomingSessionsErrors,
 ...
 */
export const listMarketplaceApps = <ThrowOnError extends boolean = false>(
  options?: Options<ListMarketplaceAppsData, ThrowOnError>
) =>
  (options?.client ?? client).get<
    ListMarketplaceAppsResponses,
    ListMarketplaceAppsErrors,
 ...
 */
export const listTrendingApps = <ThrowOnError extends boolean = false>(
  options?: Options<ListTrendingAppsData, ThrowOnError>
) =>
  (options?.client ?? client).get<ListTrendingAppsResponses, ListTrendingAppsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const listFeaturedApps = <ThrowOnError extends boolean = false>(
  options?: Options<ListFeaturedAppsData, ThrowOnError>
) =>
  (options?.client ?? client).get<ListFeaturedAppsResponses, ListFeaturedAppsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const listMarketplaceCategories = <ThrowOnError extends boolean = false>(
  options?: Options<ListMarketplaceCategoriesData, ThrowOnError>
) =>
  (options?.client ?? client).get<
    ListMarketplaceCategoriesResponses,
    ListMarketplaceCategoriesErrors,
 ...
 * Get app details
 */
export const getMarketplaceApp = <ThrowOnError extends boolean = false>(
  options: Options<GetMarketplaceAppData, ThrowOnError>
) =>
  (options.client ?? client).get<GetMarketplaceAppResponses, GetMarketplaceAppErrors, ThrowOnError>(
    {
      security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const listInstalledApps = <ThrowOnError extends boolean = false>(
  options?: Options<ListInstalledAppsData, ThrowOnError>
) =>
  (options?.client ?? client).get<
    ListInstalledAppsResponses,
    ListInstalledAppsErrors,
 ...
 * Install app
 */
export const installMarketplaceApp = <ThrowOnError extends boolean = false>(
  options: Options<InstallMarketplaceAppData, ThrowOnError>
) =>
 ...
 * Uninstall app
 */
export const uninstallMarketplaceApp = <ThrowOnError extends boolean = false>(
  options: Options<UninstallMarketplaceAppData, ThrowOnError>
) =>
 ...
 */
export const listMarketplaceItems = <ThrowOnError extends boolean = false>(
  options?: Options<ListMarketplaceItemsData, ThrowOnError>
) =>
  (options?.client ?? client).get<ListMarketplaceItemsResponses, unknown, ThrowOnError>({
 ...
 */
export const getMarketplaceItem = <ThrowOnError extends boolean = false>(
  options: Options<GetMarketplaceItemData, ThrowOnError>
) =>
  (options.client ?? client).get<
    GetMarketplaceItemResponses,
    GetMarketplaceItemErrors,
    ThrowOnError
  >({ url: '/api/v1/marketplace/items/{id}', ...options });
 ...
 */
export const searchMarketplace = <ThrowOnError extends boolean = false>(
  options?: Options<SearchMarketplaceData, ThrowOnError>
) =>
  (options?.client ?? client).post<SearchMarketplaceResponses, unknown, ThrowOnError>({
...
export const getCategoryTree = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<GetCategoryTreeResponses, unknown, ThrowOnError>({
 ...
 */
export const getMarketplaceCategory = <ThrowOnError extends boolean = false>(
  options: Options<GetMarketplaceCategoryData, ThrowOnError>
) =>
  (options.client ?? client).get<
    GetMarketplaceCategoryResponses,
    GetMarketplaceCategoryErrors,
    ThrowOnError
  >({ url: '/api/v1/marketplace/categories/{id}', ...options });
 ...
 */
export const listDeveloperApps = <ThrowOnError extends boolean = false>(
  options?: Options<ListDeveloperAppsData, ThrowOnError>
) =>
  (options?.client ?? client).get<
    ListDeveloperAppsResponses,
    ListDeveloperAppsErrors,
 ...
 * Create app
 */
export const createDeveloperApp = <ThrowOnError extends boolean = false>(
  options?: Options<CreateDeveloperAppData, ThrowOnError>
) =>
  (options?.client ?? client).post<
    CreateDeveloperAppResponses,
    CreateDeveloperAppErrors,
 ...
 */
export const deleteDeveloperApp = <ThrowOnError extends boolean = false>(
  options: Options<DeleteDeveloperAppData, ThrowOnError>
) =>
  (options.client ?? client).delete<
    DeleteDeveloperAppResponses,
    DeleteDeveloperAppErrors,
 ...
 * Get developer app
 */
export const getDeveloperApp = <ThrowOnError extends boolean = false>(
  options: Options<GetDeveloperAppData, ThrowOnError>
) =>
  (options.client ?? client).get<GetDeveloperAppResponses, GetDeveloperAppErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/developer/apps/{appId}',
    ...options,
  });
 ...
 * Update app
 */
export const updateDeveloperApp = <ThrowOnError extends boolean = false>(
  options: Options<UpdateDeveloperAppData, ThrowOnError>
) =>
 ...
 */
export const submitDeveloperApp = <ThrowOnError extends boolean = false>(
  options: Options<SubmitDeveloperAppData, ThrowOnError>
) =>
  (options.client ?? client).post<
    SubmitDeveloperAppResponses,
    SubmitDeveloperAppErrors,
 ...
 */
export const resubmitDeveloperApp = <ThrowOnError extends boolean = false>(
  options: Options<ResubmitDeveloperAppData, ThrowOnError>
) =>
  (options.client ?? client).post<
    ResubmitDeveloperAppResponses,
    ResubmitDeveloperAppErrors,
...
export const getStorage = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<GetStorageResponses, GetStorageErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/storage',
    ...options,
  });
 ...
 */
export const createUiNotification = <ThrowOnError extends boolean = false>(
  options?: Options<CreateUiNotificationData, ThrowOnError>
) =>
  (options?.client ?? client).post<
    CreateUiNotificationResponses,
    CreateUiNotificationErrors,
 ...
 */
export const createPersonalAccessToken = <ThrowOnError extends boolean = false>(
  options: Options<CreatePersonalAccessTokenData, ThrowOnError>
) =>
  (options.client ?? client).post<
    CreatePersonalAccessTokenResponses,
    CreatePersonalAccessTokenErrors,
 ...
 */
export const revokePersonalAccessToken = <ThrowOnError extends boolean = false>(
  options: Options<RevokePersonalAccessTokenData, ThrowOnError>
) =>
  (options.client ?? client).delete<
    RevokePersonalAccessTokenResponses,
    RevokePersonalAccessTokenErrors,
