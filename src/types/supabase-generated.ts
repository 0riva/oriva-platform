  ...
  public: {
    Tables: {
      ...
      app_webhooks: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_app_webhooks_app_id"
            columns: ["app_id"]
            isOneToOne: false
            referencedRelation: "hugo_apps"
      ...
      hugo_apps: {
        ...
        Relationships: [
          {
            foreignKeyName: "hugo_apps_personality_schema_id_fkey"
            columns: ["personality_schema_id"]
            isOneToOne: false
            referencedRelation: "hugo_personality_schemas"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      hugo_conversations: {
        ...
        Relationships: [
          {
            foreignKeyName: "hugo_conversations_app_id_fkey"
            columns: ["app_id"]
            isOneToOne: false
            referencedRelation: "hugo_apps"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "hugo_conversations_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      hugo_knowledge_entries: {
        ...
        Relationships: [
          {
            foreignKeyName: "hugo_knowledge_entries_knowledge_base_id_fkey"
            columns: ["knowledge_base_id"]
            isOneToOne: false
            referencedRelation: "hugo_knowledge_bases"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      hugo_personality_schemas: {
        ...
        Relationships: [
          {
            foreignKeyName: "hugo_personality_schemas_parent_schema_id_fkey"
      ...
      hugo_user_memories: {
        Row: {
          ...
          last_accessed_at: string | null
          memory_type: string
          relevance_decay_rate: number | null
          user_id: string
        }
        Insert: {
          app_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "hugo_user_memories_app_id_fkey"
            columns: ["app_id"]
            isOneToOne: false
            referencedRelation: "hugo_apps"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "hugo_user_memories_conversation_id_fkey"
            columns: ["conversation_id"]
            isOneToOne: false
            referencedRelation: "hugo_conversations"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "hugo_user_memories_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      notification_state: {
        ...
        Relationships: [
          {
            foreignKeyName: "notification_state_notification_id_fkey"
      ...
      notification_sync_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "notification_sync_log_notification_id_fkey"
            columns: ["notification_id"]
            isOneToOne: false
      ...
      platform_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_platform_events_app_id"
            columns: ["app_id"]
            isOneToOne: false
            referencedRelation: "hugo_apps"
            referencedColumns: ["app_id"]
      ...
      platform_notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_platform_notifications_app_id"
            columns: ["app_id"]
            isOneToOne: false
            referencedRelation: "hugo_apps"
            referencedColumns: ["app_id"]
    ...
    Views: {
      ...
      daily_opportunity_stats: {
        Row: {
          date: string | null
          opportunities_enabled: boolean | null
