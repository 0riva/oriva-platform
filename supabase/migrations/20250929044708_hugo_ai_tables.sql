...
CREATE INDEX idx_user_context ON hugo_collaboration_memory (user_id, context_type);
CREATE INDEX idx_app_user ON hugo_collaboration_memory (app_id, user_id);
CREATE INDEX idx_created_at ON hugo_collaboration_memory (created_at DESC);
CREATE INDEX idx_expires_at ON hugo_collaboration_memory (expires_at);
CREATE INDEX idx_metadata_tags ON hugo_collaboration_memory USING gin ((metadata->'tags') jsonb_path_ops);
...
CREATE INDEX idx_user_session ON hugo_learning_data (user_id, session_id);
CREATE INDEX idx_domain ON hugo_learning_data (domain);
CREATE INDEX idx_created_learning ON hugo_learning_data (created_at DESC);
...
CREATE INDEX idx_user_insights ON hugo_user_insights (user_id, created_at DESC);
CREATE INDEX idx_domain_insights ON hugo_user_insights (domain, insight_type);
...
CREATE INDEX idx_user_analysis ON hugo_analysis_results (user_id, created_at DESC);
...
CREATE INDEX idx_user_progress ON hugo_user_progress (user_id, domain, timestamp DESC);
